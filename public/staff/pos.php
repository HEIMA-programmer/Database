...
// =============================================
// 【数据准备层】调用 DBProcedures 和 functions
// =============================================
...
// 准备 POS 页面数据
$pageData = preparePOSPageData($pdo, $shopId, $search);
$items = $pageData['search_results'];
$posCart = $pageData['cart'];
$cartTotal = $pageData['total'];
$cartCount = count($posCart);
                        ...
                        <div class="card h-100 border-secondary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="badge bg-secondary"><?= h($item['ConditionGrade']) ?></span>
                                    <small class="text-muted">#<?= $item['StockItemID'] ?></small>
                                </div>
                                <h5 class="card-title text-white text-truncate"><?= h($item['Title']) ?></h5>
                                <p class="card-text text-warning fw-bold fs-4"><?= formatPrice($item['UnitPrice']) ?></p>
